# Inequality Headlines — Dataset Documentation

This repository contains data and analysis code for two studies examining how AI-reframed news headlines about economic inequality affect reader engagement and belief updating.
...
├── pretest_analysis.Rmd               # Study 1 analysis script
├── study_2.Rmd                        # Study 2 analysis script
├── supplementary_information.Rmd      # Supplementary heterogeneity analyses
├── inequality_headlines_S1.docx       # Study 1 Qualtrics survey instrument
└── inequality_headlines_2.docx        # Study 2 Qualtrics survey instrument
```
...
- All raw Qualtrics CSV files contain metadata rows at the top; skip the first 86 rows (Study 1) or 12 rows (Study 2) when reading.
...
- `StartDate` and `EndDate` are retained in the raw files but not included in the processed long-format files.
